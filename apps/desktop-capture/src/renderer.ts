...
document.querySelector("#open-workspace")!.addEventListener("click", () => window.collector.capture.openWorkspace());
document.querySelector("#open-settings")!.addEventListener("click", () => window.collector.capture.openSettings());
