...
export function initWorkspace(root: HTMLElement) {
  ...
  document.querySelector("#new-capture")?.addEventListener("click", () => bridge.navigateTo('capture'));
  document.querySelector("#open-settings")?.addEventListener("click", () => bridge.navigateTo('settings'));
