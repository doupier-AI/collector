...
import { filterResearchMapObservation, focusResearchMapObservation, researchMapRootMarkerNodeIds, withResearchMapIsolates, withResearchMapRevealTarget } from "./research-map-observation";
...
export function ResearchMapLandingPage() {
  ...
  const rootMarkerNodeIds = useMemo(
    () => observationEntry ? researchMapRootMarkerNodeIds(observationEntry.value) : new Set<string>(),
    [observationEntry],
  );
      ...
      {observation.nodes.length === 0 ? (
        ...
        <div className="map-landing__surface" aria-busy={updating}>
          <GlobalResearchMap
            ...
            rootMarkerNodeIds={rootMarkerNodeIds}
