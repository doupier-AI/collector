...
test("creates formal versioned tables", async (t) => {
  ...
  for (const table of ["model_calls", "research_sessions", "research_messages", "research_tasks", "research_task_events", "research_reasoning_records", "research_attachments", "research_import_tasks", "research_content_snapshots", "research_import_task_events", "research_chapter_tasks", "research_sidecar_records", "research_term_marker_tasks", "research_selections", "research_branches", "research_later_items", "research_grounding_runs", "research_grounding_sources", "research_citations", "provider_credentials", "model_purpose_routes", "model_capability_snapshots", "model_capability_probe_tasks", "research_nodes", "research_edges", "research_slices", "research_fusion_proposals", "research_body_versions", "research_semantic_fragments", "projects", "research_association_hints", "research_temporary_fusion_nodes", "research_fusion_draft_versions", "research_fusion_draft_revalidation_tasks", "research_candidate_source_connections", "research_confirmed_fusion_snapshots"]) assert.ok(tables.includes(table));
