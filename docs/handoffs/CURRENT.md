...
| 基线 | 版本 | 本轮是否变化 |
| --- | --- | --- |
| 多模型协作协议 | `COLLAB-PROTOCOL 1.1.0` | Minor：第 7.3 节增加分级验证 |
| WebUI 前端实施基线 | `FRONTEND-BASELINE 1.1.0` | Minor：第 14.3 节改为分级验证命令 |
...
本次版本变化的增量章节是协作协议第 7.3 节和前端基线第 14.3 节。KIMI 3 因首次接手仍完整读取两份基线；后续参与者只需在 `CURRENT.md` 要求时读取发生变化的章节。
